...
Refund <- read.csv("../Clover/Sales2412-2511/Refunds-20240909-20241231.csv", as.is = T) %>% mutate(Date = as.Date(gsub(" .*", "", Refund.Date), format = "%d-%b-%Y"), Month = format(Date, "%b"), DayOfWeek = format(Date, "%a")) %>% select(Date, Month, DayOfWeek, Refund.Amount, Refund.ID)
```

This is report of Richmond showroom performance from Dec 01 2024 to Nov 30 2025.  
